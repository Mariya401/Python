...
if revenue > costs:
    print(f"Финансовый результат - прибыль: " f"{(revenue-costs)}")
    print(f"Рентабельность:" f"{round((revenue-costs)/costs*100,1)}")
    number = int(input("Введите численность сотрудников фирмы: "))
    print(f"Прибыль фирмы в расчете на одного сотрудника:" f"{round((revenue-costs)/number, 2)}")
else:
